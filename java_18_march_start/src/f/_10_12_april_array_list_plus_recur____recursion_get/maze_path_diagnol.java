...
public class maze_path_diagnol
{
static Scanner scn = new Scanner(System.in);
	...
	public static ArrayList<String> get_maze_path(int current_row, int current_col, int end_row, int end_col)
	{
		...
		ArrayList<String> recursn_result_diagnol = get_maze_path(current_row+1, current_col+1, end_row, end_col);
		for(String val:recursn_result_diagnol)
		{
			mr.add("D" + val);
		}
		return mr;
